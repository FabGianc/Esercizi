...
# Inizializzo la variabile booleana che indicherà la prsenza di una coppia di valori positivi oppure no
positivo = False
...
if positivo:
    ...
    print("Non hai inserito alcuna coppia di valori positivi")